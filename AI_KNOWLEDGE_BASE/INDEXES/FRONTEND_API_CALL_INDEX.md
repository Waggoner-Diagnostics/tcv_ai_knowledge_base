...
| PUT | `/api/password/change` | `API-051` PasswordController@update | [src/redux/slices/userProfile/passwordChangeSlice.js:10](../../../TCV-Frontend/src/redux/slices/userProfile/passwordChangeSlice.js#L10) |
...
| POST | `/api/verify-password` | `API-176` AuthController@verifyPassword | [src/redux/slices/auth/passwordVerificationSlice.js:8](../../../TCV-Frontend/src/redux/slices/auth/passwordVerificationSlice.js#L8) |
