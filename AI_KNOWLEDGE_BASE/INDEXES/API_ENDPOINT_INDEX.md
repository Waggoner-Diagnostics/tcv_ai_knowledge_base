...
| `API-011` | GET|HEAD | `api/audit-logs/export` | AuditLogController@export | `auth:sanctum` | — |
| `API-012` | GET|HEAD | `api/audit-logs/people` | AuditLogController@people | `auth:sanctum` | — |
| `API-013` | GET|HEAD | `api/audit-logs/{id}` | AuditLogController@show | `auth:sanctum` | — |
| `API-014` | POST | `api/contact` | ContactController@submit | `auth:sanctum` · `throttle:10,1` | — |
| `API-015` | GET|HEAD | `api/countries-with-states` | DropdownValuesController@getCountriesWithStates | — | — |
| `API-016` | GET|HEAD | `api/credits` | CreditsController@index | `auth:sanctum` | — |
| `API-017` | POST | `api/credits` | CreditsController@store | `auth:sanctum` | — |
| `API-018` | GET|HEAD | `api/credits/coupon/{coupon_code}` | CreditsController@checkDiscountCodeValidity | `auth:sanctum` | — |
| `API-019` | DELETE | `api/credits/{credit}` | CreditsController@destroy | `auth:sanctum` | — |
| `API-020` | GET|HEAD | `api/credits/{credit}` | CreditsController@show | `auth:sanctum` | — |
| `API-021` | PUT|PATCH | `api/credits/{credit}` | CreditsController@update | `auth:sanctum` | — |
| `API-022` | GET|HEAD | `api/discount-codes` | DiscountCodeController@index | `auth:sanctum` | — |
| `API-023` | POST | `api/discount-codes` | DiscountCodeController@store | `auth:sanctum` | — |
| `API-024` | GET|HEAD | `api/discount-codes/code-available` | DiscountCodeController@codeAvailable | `auth:sanctum` | — |
| `API-025` | GET|HEAD | `api/discount-codes/form-options` | DiscountCodeController@formOptions | `auth:sanctum` | — |
| `API-026` | GET|HEAD | `api/discount-codes/stats` | DiscountCodeController@stats | `auth:sanctum` | — |
| `API-027` | POST | `api/discount-codes/validate` | DiscountCodeController@validateCode | `auth:sanctum` | — |
| `API-028` | DELETE | `api/discount-codes/{discount_code}` | DiscountCodeController@destroy | `auth:sanctum` | — |
| `API-029` | GET|HEAD | `api/discount-codes/{discount_code}` | DiscountCodeController@show | `auth:sanctum` | — |
| `API-030` | PUT|PATCH | `api/discount-codes/{discount_code}` | DiscountCodeController@update | `auth:sanctum` | — |
| `API-031` | PATCH | `api/discount-codes/{discount_code}/toggle` | DiscountCodeController@toggle | `auth:sanctum` | — |
| `API-032` | POST | `api/distributor-enquiry` | DistributorController@submit | `throttle:10,1` | — |
| `API-033` | GET|HEAD | `api/dropdown/allowed-tests` | DropdownValuesController@activeAllowedTests | `auth:sanctum` | — |
| `API-034` | GET|HEAD | `api/dropdown/compliances` | DropdownValuesController@activeCompliances | `auth:sanctum` | — |
| `API-035` | GET|HEAD | `api/dropdown/organization-settings-options` | DropdownValuesController@activeOrgSettingsOptions | `auth:sanctum` | — |
| `API-036` | GET|HEAD | `api/dropdown/organization-types` | DropdownValuesController@activeOrganizationTypes | `auth:sanctum` | — |
| `API-037` | GET|HEAD | `api/dropdown/privileges` | DropdownValuesController@activePrivileges | `auth:sanctum` | — |
| `API-038` | POST | `api/impersonate/{id}` | AuthController@impersonateUser | `auth:sanctum` | — |
| `API-039` | POST | `api/login` | AuthController@login | `throttle:login` | — |
| `API-040` | POST | `api/logout` | AuthController@logout | `auth:sanctum` | — |
| `API-041` | POST | `api/organization/patient/default` | OrganizationPatientController@storeDefaultPatient | `FlexibleAuthMiddleware` · `LmsSessionStatusMiddleware:launched,identity_resolved` | — |
| `API-042` | POST | `api/organization/patient/prolific` | OrganizationPatientController@storeProlificPatient | `FlexibleAuthMiddleware` · `LmsSessionStatusMiddleware:launched,identity_resolved` | — |
| `API-043` | GET|HEAD | `api/organization/patientForm` | OrganizationController@getPatientForm | `FlexibleAuthMiddleware` | — |
| `API-044` | GET|HEAD | `api/organization/privileges` | OrganizationController@getOrganizationPrivileges | `FlexibleAuthMiddleware` | — |
| `API-045` | GET|HEAD | `api/organization/redirect-url` | OrganizationController@getOrganizationRedirectUrl | `FlexibleAuthMiddleware` | — |
| `API-046` | GET|HEAD | `api/organization/test` | _(closure)_ | `auth:sanctum` · `signed` | — |
| `API-047` | GET|HEAD | `api/organization/tests/default` | OrganizationController@getDefaultTests | `FlexibleAuthMiddleware` | — |
| `API-048` | POST | `api/organization/verify-signature` | OrganizationController@verifySignature | `throttle:signature-verify` | — |
| `API-049` | GET|HEAD | `api/organizations` | OrganizationController@index | `auth:sanctum` | — |
| `API-050` | POST | `api/organizations` | OrganizationController@store | `auth:sanctum` | — |
| `API-051` | POST | `api/organizations/{id}/upload-logo` | OrganizationController@uploadLogo | `auth:sanctum` | — |
| `API-052` | DELETE | `api/organizations/{organization}` | OrganizationController@destroy | `auth:sanctum` | — |
| `API-053` | GET|HEAD | `api/organizations/{organization}` | OrganizationController@show | `auth:sanctum` | — |
| `API-054` | PUT|PATCH | `api/organizations/{organization}` | OrganizationController@update | `auth:sanctum` | — |
| `API-055` | PUT | `api/password/change` | PasswordController@update | `auth:sanctum` | — |
| `API-056` | POST | `api/password/forgot` | AuthController@sendResetLinkEmail | `throttle:password-reset` | — |
| `API-057` | POST | `api/password/reset` | AuthController@setOrResetPassword | `throttle:password-reset` | — |
| `API-058` | POST | `api/password/verify-setup-token` | AuthController@verifySetupToken | `throttle:password-reset` | — |
| `API-059` | POST | `api/patient-tests/{identifier}/revoke-credit` | CreditsController@revokeCredit | `auth:sanctum` | — |
| `API-060` | GET|HEAD | `api/patients` | PatientController@index | `FlexibleAuthMiddleware` | — |
| `API-061` | POST | `api/patients` | PatientController@store | `FlexibleAuthMiddleware` | — |
| `API-062` | GET|HEAD | `api/patients/{id}/tests` | PatientController@getPatientTests | `auth:sanctum` | — |
