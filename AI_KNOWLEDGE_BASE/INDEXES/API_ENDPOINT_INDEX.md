...
| `API-009` | GET|HEAD | `api/audit-logs` | AuditLogController@index | `auth:sanctum` | — |
| `API-010` | GET|HEAD | `api/audit-logs/people` | AuditLogController@people | `auth:sanctum` | — |
| `API-011` | GET|HEAD | `api/audit-logs/{id}` | AuditLogController@show | `auth:sanctum` | — |
| `API-012` | POST | `api/contact` | ContactController@submit | `auth:sanctum` · `throttle:10,1` | — |
| `API-013` | GET|HEAD | `api/countries-with-states` | DropdownValuesController@getCountriesWithStates | — | — |
| `API-014` | GET|HEAD | `api/credits` | CreditsController@index | `auth:sanctum` | — |
| `API-015` | POST | `api/credits` | CreditsController@store | `auth:sanctum` | — |
| `API-016` | GET|HEAD | `api/credits/coupon/{coupon_code}` | CreditsController@checkDiscountCodeValidity | `auth:sanctum` | — |
| `API-017` | DELETE | `api/credits/{credit}` | CreditsController@destroy | `auth:sanctum` | — |
| `API-018` | GET|HEAD | `api/credits/{credit}` | CreditsController@show | `auth:sanctum` | — |
| `API-019` | PUT|PATCH | `api/credits/{credit}` | CreditsController@update | `auth:sanctum` | — |
| `API-020` | GET|HEAD | `api/discount-codes` | DiscountCodeController@index | `auth:sanctum` | — |
| `API-021` | POST | `api/discount-codes` | DiscountCodeController@store | `auth:sanctum` | — |
| `API-022` | GET|HEAD | `api/discount-codes/code-available` | DiscountCodeController@codeAvailable | `auth:sanctum` | — |
| `API-023` | GET|HEAD | `api/discount-codes/form-options` | DiscountCodeController@formOptions | `auth:sanctum` | — |
| `API-024` | GET|HEAD | `api/discount-codes/stats` | DiscountCodeController@stats | `auth:sanctum` | — |
| `API-025` | POST | `api/discount-codes/validate` | DiscountCodeController@validateCode | `auth:sanctum` | — |
| `API-026` | DELETE | `api/discount-codes/{discount_code}` | DiscountCodeController@destroy | `auth:sanctum` | — |
