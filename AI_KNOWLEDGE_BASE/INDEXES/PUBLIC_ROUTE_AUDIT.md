...
**17 of 163 endpoints are public.**
...
| `API-031` | POST | `api/distributor-enquiry` | DistributorController@submit |
| `API-038` | POST | `api/login` | AuthController@login |
| `API-047` | POST | `api/organization/verify-signature` | OrganizationController@verifySignature |
| `API-055` | POST | `api/password/forgot` | AuthController@sendResetLinkEmail |
| `API-056` | POST | `api/password/reset` | AuthController@setOrResetPassword |
| `API-057` | POST | `api/password/verify-setup-token` | AuthController@verifySetupToken |
| `API-076` | POST | `api/register` | AuthController@register |
